...
class BoardController extends Controller
{
    public function index() {
        ...
        $result = DB::select(
            'SELECT cat.name,
                COUNT(bo.categories_no)
            FROM boards bo
                JOIN categories cat
                    ON bo.categories_no = cat.no
            GROUP BY bo.categories_no, cat.name'
        );
        ...
        $result = DB::table('boards')->orderBy('id', 'desc')->first(); // 역순
